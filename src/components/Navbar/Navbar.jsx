...
return (
    ...
    <nav className="relative flex items-center justify-between sm:h-10 lg:justify-end" aria-label="Global">
      ...
      <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
        <a href="" className="font-medium text-indigo-500 hover:text-white duration-500">App</a>
        <a href="" className="font-medium text-gray-500 hover:text-white duration-500">Exchange</a>
      </div>
      <a href="#">
